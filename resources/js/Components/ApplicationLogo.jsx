...
export default function AplicationLogo({ bgLogo, colorLogo, colorText }) {
    return (
        <Link href="#" className={cn('flex flex-row items-center gap-2')}>
            <div
                className={cn(
            ...
            <div className={cn('grid flex-1 text-left leading-tight', colorText)}>
                ...
                <span className="truncate text-xs tracking-tighter">Teman Mahasiswa</span>
            </div>
        </Link>
    );
}
