...
export default function Create(props) {
    const { data, setData, post, processing, errors, reset } = useForm({
        fakultas_id: props.schedule.fakultas_id ?? null,
        departemen_id: props.schedule.departemen_id ?? null,
        kelas_id: props.schedule.kelas_id ?? null,
        course_id: props.schedule.course_id ?? null,
        start_time: props.schedule.start_time ?? null,
        end_time: props.schedule.end_time ?? null,
        day_of_week: props.schedule.day_of_week ?? null,
        qoute: props.schedule.qoute ?? 0,
