...
export default function Edit(props) {
    const { data, setData, post, processing, errors, reset } = useForm({
        name: props.academic_year.name ?? '',
        start_date: props.academic_year.start_date ?? '',
        end_date: props.academic_year.end_date ?? '',
        semester: props.academic_year.semester ?? null,
        is_active: props.academic_year.is_active ?? false,
            ...
            <Card>
                <CardContent className="px-6">
                    <form onSubmit={onhandleSubmit}>
                        <div className="grid grid-cols-1 gap-4 p-3 lg:grid-cols-4 lg:p-4">
                            {/* NAME */}
